...
import { getAntigoneMemoryStore, type AntigoneMemoryStore } from "./antigoneMemory";
...
export function createAppRouter(deps: { antigoneMemory?: AntigoneMemoryStore } = {}) {
  const resolveAntigoneMemory = () => deps.antigoneMemory ?? getAntigoneMemoryStore();
  ...
  return router({
    ...
    antigone: createAntigoneRouter(resolveAntigoneMemory),
  });
}
